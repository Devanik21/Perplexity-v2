...
![Language](https://img.shields.io/badge/Language-Python-3776AB?style=flat-square) ![Stars](https://img.shields.io/github/stars/Devanik21/Perplexity-v2?style=flat-square&color=yellow) ![Forks](https://img.shields.io/github/forks/Devanik21/Perplexity-v2?style=flat-square&color=blue) ![Author](https://img.shields.io/badge/Author-Devanik21-black?style=flat-square&logo=github) ![Status](https://img.shields.io/badge/Status-Active-brightgreen?style=flat-square)

> Perplexity V2 — a thoughtfully built LLM-powered conversational application for intelligent, context-aware dialogue.

---

**Topics:** `deep-learning` · `generative-ai` · `information-retrieval` · `knowledge-grounding` · `large-language-models` · `multimodal-retrieval` · `nlp` · `relevance-ranking` · `retrieval-augmented-generation` · `search-grounded-generation`

## Overview

Perplexity V2 is an LLM-powered application that provides a clean, functional interface for interacting with frontier language models. It goes beyond a simple prompt-response wrapper: it maintains conversation memory, supports configurable system prompts for persona and task specialisation, and provides streaming output for a responsive chat experience.
...
> **Key packages detected in this repo:** `streamlit` · `google-generativeai` · `beautifulsoup4` · `requests` · `PyMuPDF` · `pandas` · `python-docx` · `docx2txt` · `python-pptx` · `openpyxl`
...
```bash
git clone https://github.com/Devanik21/Perplexity-v2.git
cd Perplexity-v2
